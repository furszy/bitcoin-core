...
path used is the argument path appended with `/test_temp/<test-name>/datadir`.
...
Test directory (will not be deleted): "/somewhere/mydatadir/test_temp/getarg_tests/doubledash/datadir
Running 1 test case...

*** No errors detected
$ ls -l /somewhere/mydatadir/test_temp/getarg_tests/doubledash/datadir
total 8
