    ...
    return RPCHelpMan{"getwalletinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::BOOL, "blank", /*optional=*/true, "whether this wallet intentionally does not contain any keys, scripts, or descriptors (only visible for testing)"},
                    }},
                },
                RPCExamples{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (Params().IsTestChain()) {
        // This flag is only visible for testing purposes and will be removed/renamed in the future.
