...
bool ReadKeyValue(CWallet* pwallet, WalletBatch& batch, CDataStream& ssKey, CDataStream& ssValue, std::string& strType, std::string& strErr, const KeyFilterFn& filter_fn = nullptr);
