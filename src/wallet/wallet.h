...
private:
     ...
     */
    // Maps skpm id to a pair of <last_script_index, filter>
    using FilterBySPKM = std::map<uint256, std::pair<size_t, CBloomFilter>>;
    FilterBySPKM m_elements_by_spkm; // TODO: guard by a mutex
