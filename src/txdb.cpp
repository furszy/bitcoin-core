...
std::optional<Coin> CCoinsViewDB::GetCoin(const COutPoint& outpoint) const
{
    ...
    switch (read_status.status) {
        ...
        case CDBWrapper::ReadStatus::Code::DESERIALIZATION_ERROR:
            throw dbwrapper_error{strprintf("Coin deserialization failure: chainstate database is corrupt. Error msg %s", *read_status.op_error)};
        case CDBWrapper::ReadStatus::Code::DB_INTERNAL_ERROR:
            throw dbwrapper_error{strprintf("Coin read failure: internal database problem. Error msg %s", *read_status.op_error)};
    }
