...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_multisig(self):
        ...
        assert_equal(ms1_watchonly.getaddressinfo(addr1)["ismine"], False)
        assert_equal(ms1_watchonly.getaddressinfo(addr1)["iswatchonly"], True)
        ...
        assert_equal(ms1_solvable.getaddressinfo(addr2)["ismine"], False)
        assert_equal(ms1_solvable.getaddressinfo(addr2)["iswatchonly"], True)
