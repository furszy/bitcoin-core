...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_bump_tx_info(self):
        self.log.info("Test that tx comments are preserved during migration")
        def_wallet = self.nodes[0].get_wallet_rpc(self.default_wallet_name)
        ...
        # Create tx and bump it to store 'replaced_by_txid' and 'replaces_txid' comments within the transactions
