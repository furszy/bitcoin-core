...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_miniscript(self):
        ...
        assert_equal(res["segwit"]["desc"], "wsh(raw(82012088a914ffffffffffffffffffffffffffffffffffffffff882102ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffacb2))#ra6w2xa7")
