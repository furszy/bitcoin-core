...
class PrioritiseTransactionTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, "Expected type number, got string", self.nodes[0].prioritisetransaction, txid, 'foo', 0)
        ...
        assert_raises_rpc_error(-1, "Expected type number, got string", self.nodes[0].prioritisetransaction, txid=txid, fee_delta='foo')
