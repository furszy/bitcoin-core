...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_double_change(self):
        ...
        # Essentially, fundrawtxn shouldn't create a second change output if there is one already going to that address
    ...
    def test_add_inputs_default_value(self):
        ...
        psbt_tx = wallet.walletcreatefundedpsbt(outputs=[{addr1: 9}], inputs=inputs, options=options)
    ...
    # returns the index of the first output sending coins to the wallet
    ...
    def test_coin_selection_for_replacement_tx(self):
        ...
        # So, coin selection must fail, because there are no other available coins to fund the remaining 0.4 BTC.
