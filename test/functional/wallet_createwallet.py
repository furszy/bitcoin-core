...
class CreateWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(w1.getwalletinfo()["blank"], True)
        ...
        assert_equal(w2.getwalletinfo()["blank"], True)
        ...
        assert_equal(w3.getwalletinfo()["blank"], True)
        ...
        assert_equal(w4.getwalletinfo()["blank"], True)
        ...
        assert_equal(w5.getwalletinfo()["blank"], True)
        ...
        assert_equal(wblank.getwalletinfo()["blank"], True)
        ...
        assert_equal(w6.getwalletinfo()["blank"], False)
