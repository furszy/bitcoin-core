...
class RpcCreateMultiSigTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        self.has_wallet = self.enable_wallet_if_possible()
    ...
    def run_test(self):
        ...
        self.create_keys(20)  # max number of allowed keys
    ...
    def do_multisig(self, nkeys, nsigs, output_type, wallet_multi):
        ...
        node2_balance = node2.getbalances()['mine']['trusted'] if self.has_wallet else 0
        out_addr = node2.getnewaddress() if self.has_wallet else getnewdestination('bech32')[2]
