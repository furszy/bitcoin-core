...
class BudgetTest(PivxTier2TestFramework):
    ...
    def run_test(self):
        ...
        self.finalize_and_vote_budget()
        self.stake(2, [self.remoteOne, self.remoteTwo, self.remoteThree])
        self.check_address_balance(prop1.paymentAddr, prop1.amountPerCycle * 2)
        self.check_address_balance(prop2.paymentAddr, prop2.amountPerCycle * 2)
