...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def getrawtransaction_tests(self):
        ...
        for n in [0, 2]:
            ...
            for value in ["True", "False"]:
                assert_raises_rpc_error(-1, "Expected type bool, got string", self.nodes[n].getrawtransaction, txid=txId, verbose=value)

            # 7. invalid parameters - supply txid and empty array
            assert_raises_rpc_error(-1, "Expected type bool, got array", self.nodes[n].getrawtransaction, txId, [])

            # 8. invalid parameters - supply txid and empty dict
            assert_raises_rpc_error(-1, "Expected type bool, got object", self.nodes[n].getrawtransaction, txId, {})
        ...
        for n in [0, 2]:
            ...
            assert_raises_rpc_error(-1, "Expected type string, got bool", self.nodes[n].getrawtransaction, txid=tx, blockhash=True)
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-1, "Expected type object, got string", self.nodes[0].createrawtransaction, ['foo'], {})
        assert_raises_rpc_error(-1, "Expected type string, got null", self.nodes[0].createrawtransaction, [{}], {})
        ...
        address = getnewdestination()[2]
        assert_raises_rpc_error(-1, "Expected type array, got string", self.nodes[0].createrawtransaction, [], 'foo')
