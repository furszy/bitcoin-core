...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "coins -> policy/fees -> txmempool -> evo/specialtx -> coins"
    ...
    "chainparams -> checkpoints -> validation -> evo/specialtx -> evo/providertx -> key_io -> chainparams"
    "base58 -> chainparams -> checkpoints -> validation -> evo/specialtx -> evo/providertx -> key_io -> base58"
)
